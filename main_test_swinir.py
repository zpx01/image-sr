...
def main():
    ...
    parser.add_argument('--type', type=str, default='swinir', help='default is swinir, write ttt for testing ttt models', required=True)
    ...
    parser.add_argument('--model_path', type=str, default=None, help='use this only for swinir, enter the exact model weights file path')
...
def setup(args):
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        save_dir = f'{args.results_path}/swinir_{args.task}_x{args.scale}_{args.img_identifier}'
    ...
    # 004 grayscale image denoising/ 005 color image denoising
        ...
        save_dir = f'{args.results_path}/swinir_{args.task}_noise{args.noise}'
        folder = args.folder_gt
        border = 0
        window_size = 8
    ...
    # 006 JPEG compression artifact reduction
        ...
        save_dir = f'{args.results_path}/swinir_{args.task}_jpeg{args.jpeg}'
        folder = args.folder_gt
        border = 0
        window_size = 7
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        ...
        if 'HR' not in imgname:
            ...
            try:
                ...
                raise ValueError(f'Could not load {args.folder_lq}/{imgname}{imgext}')
        else:
